...
//
//    @ManyToOne(fetch = FetchType.LAZY)
//    @JoinColumn(name = "user_id", nullable = true) // ✅ Changed to nullable = true for walk-in
//    @JsonIgnore
...
//
//    // ✅ ADD THESE NEW FIELDS for walk-in bookings
...
////        // ✅ Set default amountPaid = totalAmount if not specified
...
//    }
//
//    // 3. ✅ Update @PrePersist to handle walk-ins
//    @PrePersist
//    protected void onCreate() {
//        createdAt = LocalDateTime.now();
//        bookingDate = LocalDateTime.now();
